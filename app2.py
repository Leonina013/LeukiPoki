...
#image = Image.open(img_name).convert('RGB')
 ...
 bmi = st.sidebar.slider("What is the Body Mass Index of the person?",0.0,50.0)
...
if confidence_score >= 0.85:
 ...
 if index == 0:
  ...
  st.write("You may have a benign condition, or are free of ALL. That doesn't mean it can't be some other form of leukemia so please get it checked once during your regular body check")
